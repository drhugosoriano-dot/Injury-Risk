...
async function fbGet(collection, docId) {
  try {
    ...
    const raw = snap.data();
    return {
      jugadores:    raw.jugadores    ? JSON.parse(raw.jugadores)    : [],
      evaluaciones: raw.evaluaciones ? JSON.parse(raw.evaluaciones) : {},
      evalData:     raw.evalData     ? JSON.parse(raw.evalData)     : {},
    };
